...
class ImagingSonarSensor_ROS(Camera):
    def __init__(self, 
                 prim_path, 
    ...
    def make_sonar_data(self, 
        ...
        if self._og_node:
                ...
                og.Controller.attribute(self._og_node.get_attribute("inputs:width")).set(sonar_vis_frame.shape[1])
                og.Controller.attribute(self._og_node.get_attribute("inputs:height")).set(sonar_vis_frame.shape[0])
                og.Controller.attribute(self._og_node.get_attribute("inputs:data")).set(sonar_vis_frame)
